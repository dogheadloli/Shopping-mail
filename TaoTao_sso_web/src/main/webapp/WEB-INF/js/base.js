...
}(), window.pageConfig = window.pageConfig || {}, "undefined" == typeof pageConfig.autoConfig && (pageConfig.autoConfig = !0), "undefined" == typeof pageConfig.preload && (pageConfig.preload = !0), pageConfig.autoConfig) {
    var preloadArray = pageConfig.preload ? ["jdf/1.0.0/ui/ui/1.0.0/ui.js"] : [];
    var seajsConfig = {base: "http://misc.360buyimg.com/", alias: {}, map: [], preload: preloadArray, debug: 0};
    /isdebug=(-\d)*-1/.test(location.search) && (seajsConfig.comboExcludes = /.*/), seajs.config(seajsConfig)
}
pageConfig.wideVersion = function () {
    return /isdebug=(-\d)*-2/.test(location.search) ? !1 : screen.width >= 1210 && pageConfig.compatible
...
}, /jd\.com|360buy\.com/.test(location.hostname) && (document.domain = pageConfig.FN_getDomain()), pageConfig.FN_GetImageDomain = function (a) {
    var b, a = String(a);
...
}, /isdebug=(-\d)*-1/.test(location.search) && !function () {
    function a() {
