...
public class TestSolrJ {
    ...
    public void testAddDocument() throws Exception {
        ...
        HttpSolrClient httpSolrClient = new HttpSolrClient.Builder("http://120.78.88.198:8080/solr/new_core").build();
    ...
    public void deleteDocumentById() throws Exception {
        ...
        /* **SolrServer solrServer = new HttpSolrServer("http://120.78.88.198:8080/solr/new_core");*/
        HttpSolrClient httpSolrClient = new HttpSolrClient.Builder("http://120.78.88.198:8080/solr/new_core").build();
        httpSolrClient.deleteById("test001");
        httpSolrClient.commit();
    }
    ...
    public void deleteByQuery() throws Exception {
        ...
        /* **SolrServer solrServer = new HttpSolrServer("http://120.78.88.198:8080/solr/new_core");*/
        HttpSolrClient httpSolrClient = new HttpSolrClient.Builder("http://120.78.88.198:8080/solr/new_core").build();
        httpSolrClient.deleteByQuery("item_title:测试商品2");
        httpSolrClient.commit();
    }
